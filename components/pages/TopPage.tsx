...
const spineBooks = useMemo(() => {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-orange-50/50 text-neutral-900">
      ...
      <Card className="relative overflow-hidden rounded-3xl border-0 shadow-sm">
            <CardHeader className="relative z-10 px-8 pt-8 pb-1">
  ...
  本を開くと、その本について話せる部屋に入れます。
        ...
        <div className="flex justify-end px-8 pb-3 sm:block sm:p-0">
  <a
